# BÖLÜM GİRDİ PROMPTU — Modern Web'e Giriş
...
- Bölüm dosyası: `chapter_01_modern_web_giris.md`
- Bölüm başlığı: Modern Web'e Giriş
- Bölüm durumu: done
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_01_01_aciklayici_ad]` standardıyla
