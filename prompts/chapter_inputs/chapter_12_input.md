# BÖLÜM GİRDİ PROMPTU — Redux Toolkit
...
- Bölüm dosyası: `chapter_12_redux.md`
- Bölüm başlığı: Redux Toolkit
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_12_01_aciklayici_ad]` standardıyla
