# BÖLÜM GİRDİ PROMPTU — React için Modern JavaScript Temelleri
...
- Bölüm dosyası: `chapter_02_javascript_temelleri.md`
- Bölüm başlığı: React için Modern JavaScript Temelleri
- Bölüm durumu: in_progress

## 2. Kitap boyunca geliştirilen uygulama

- Uygulama adı: KampüsHub
- Açıklama: Üniversite öğrencileri için öğretim amaçlı React web uygulaması

Bu bölümde uygulamaya eklenecek katkı:

Manifestte açıkça belirtilmemiştir; bölüm içeriğiyle uyumlu, küçük ve test edilebilir bir katkı tasarla.
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_02_01_aciklayici_ad]` standardıyla
