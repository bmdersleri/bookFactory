# BÖLÜM GİRDİ PROMPTU — React Router v7
...
- Bölüm dosyası: `chapter_10_router.md`
- Bölüm başlığı: React Router v7
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_10_01_aciklayici_ad]` standardıyla
