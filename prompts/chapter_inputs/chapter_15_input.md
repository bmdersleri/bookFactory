# BÖLÜM GİRDİ PROMPTU — Performans, Test ve Dağıtım
...
- Bölüm dosyası: `chapter_15_perf_test_deploy.md`
- Bölüm başlığı: Performans, Test ve Dağıtım
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_15_01_aciklayici_ad]` standardıyla
