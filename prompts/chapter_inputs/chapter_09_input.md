# BÖLÜM GİRDİ PROMPTU — Custom Hook Tasarımı
...
- Bölüm dosyası: `chapter_09_custom_hooks.md`
- Bölüm başlığı: Custom Hook Tasarımı
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_09_01_aciklayici_ad]` standardıyla
