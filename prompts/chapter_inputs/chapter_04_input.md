# BÖLÜM GİRDİ PROMPTU — JSX ve Render Mantığı
...
- Bölüm dosyası: `chapter_04_jsx_render.md`
- Bölüm başlığı: JSX ve Render Mantığı
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_04_01_aciklayici_ad]` standardıyla
