# BÖLÜM GİRDİ PROMPTU — Formlar, Validation ve Erişilebilirlik
...
- Bölüm dosyası: `chapter_11_forms.md`
- Bölüm başlığı: Formlar, Validation ve Erişilebilirlik
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_11_01_aciklayici_ad]` standardıyla
