# BÖLÜM GİRDİ PROMPTU — useEffect, Yan Etkiler ve API'ye Hazırlık
...
- Bölüm dosyası: `chapter_07_useeffect_api.md`
- Bölüm başlığı: useEffect, Yan Etkiler ve API'ye Hazırlık
- Bölüm durumu: planned
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_07_01_aciklayici_ad]` standardıyla
