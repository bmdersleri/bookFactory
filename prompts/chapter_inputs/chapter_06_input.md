# BÖLÜM GİRDİ PROMPTU — State ve Event Yönetimi
...
- Bölüm dosyası: `chapter_06_state_event.md`
- Bölüm başlığı: State ve Event Yönetimi
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_06_01_aciklayici_ad]` standardıyla
