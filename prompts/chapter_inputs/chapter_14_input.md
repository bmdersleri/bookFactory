# BÖLÜM GİRDİ PROMPTU — Zustand ve Alternatif State Yönetimi
...
- Bölüm dosyası: `chapter_14_zustand.md`
- Bölüm başlığı: Zustand ve Alternatif State Yönetimi
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_14_01_aciklayici_ad]` standardıyla
