# BÖLÜM GİRDİ PROMPTU — Hook Kuralları ve Memoization
...
- Bölüm dosyası: `chapter_08_hook_memoization.md`
- Bölüm başlığı: Hook Kuralları ve Memoization
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_08_01_aciklayici_ad]` standardıyla
