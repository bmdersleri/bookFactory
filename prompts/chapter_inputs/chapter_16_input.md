# BÖLÜM GİRDİ PROMPTU — KampüsHub Final Entegrasyonu
...
- Bölüm dosyası: `chapter_16_final.md`
- Bölüm başlığı: KampüsHub Final Entegrasyonu
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_16_01_aciklayici_ad]` standardıyla
