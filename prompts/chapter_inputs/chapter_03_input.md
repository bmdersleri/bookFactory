# BÖLÜM GİRDİ PROMPTU — HTML/CSS'ten Bileşen Düşüncesine
...
- Bölüm dosyası: `chapter_03_html_css_bilesen_dusuncesi.md`
- Bölüm başlığı: HTML/CSS'ten Bileşen Düşüncesine
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_03_01_aciklayici_ad]` standardıyla
