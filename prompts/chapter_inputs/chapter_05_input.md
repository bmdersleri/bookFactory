# BÖLÜM GİRDİ PROMPTU — Props ve Bileşen Kompozisyonu
...
- Bölüm dosyası: `chapter_05_props_kompozisyon.md`
- Bölüm başlığı: Props ve Bileşen Kompozisyonu
...
7. Programatik ekran çıktısı planı gerektiğinde `[SCREENSHOT:chapter_05_01_aciklayici_ad]` standardıyla
