...
render_all_mermaid_png_v18.py tarafından yapılır. Böylece batch akışında
aynı .mmd dosyalarından iki kez PNG oluşturma sorunu ortadan kalkar.

Örnek:
    python prepare_mermaid_images_v18.py Bolum_08_GPT_pilot.md
    python prepare_mermaid_images_v18.py Bolum_08_GPT_pilot.md --out-dir mermaid_images --clean
    python prepare_mermaid_images_v18.py Bolum_08_GPT_pilot.md --out-dir mermaid_images --force
"""
...
def main() -> int:
    ...
    print("  PNG     : Bu betikte üretilmez; render_all_mermaid_png_v18.py kullanılır.")
