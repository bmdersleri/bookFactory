...
REM DOCX conversion pipeline - v18 Windows fix
REM Single Mermaid render flow:
REM   1) prepare_mermaid_images_v18.py extracts only .mmd files
REM   2) render_all_mermaid_png_v18.py creates PNG files once
REM
REM Usage:
...
set "REFERENCE_DOC=%SCRIPT_DIR%referenceV17_java_temelleri.docx"
set "LUA_FILTER=%SCRIPT_DIR%styles_revised_v17.lua"
set "PREPARE_PY=%SCRIPT_DIR%prepare_mermaid_images_v18.py"
set "RENDER_PY=%SCRIPT_DIR%render_all_mermaid_png_v18.py"
...
echo.
echo ============================================================
echo DOCX Conversion v18 - single Mermaid PNG render
echo ============================================================
