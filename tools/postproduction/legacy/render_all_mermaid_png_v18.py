...
Bu betik Mermaid PNG üretiminin tek sorumlusudur. Önce prepare_mermaid_images_v18.py
ile .mmd dosyalarını üretin, sonra bu betiği bir kez çalıştırın.

Örnek:
    python render_all_mermaid_png_v18.py mermaid_images --pdf-fit --force
    python render_all_mermaid_png_v18.py mermaid_images --recursive --background white --width 2400 --scale 3
"""
...
def main() -> int:
    ...
    for mmd_file in mmd_files:
        ...
        cmd = build_command(mmdc_cmd, mmd_file, png_file, args.background, width, height, scale, args.theme)
